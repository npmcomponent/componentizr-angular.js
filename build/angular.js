/**
 * @license AngularJS v1.2.5-db5746d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-db5746d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-db5746d',    // all of these placeholder strings will be replaced by grunt's
