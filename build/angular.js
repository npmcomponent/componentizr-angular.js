/**
 * @license AngularJS v1.2.5-6ce7e5a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-6ce7e5a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-6ce7e5a',    // all of these placeholder strings will be replaced by grunt's
