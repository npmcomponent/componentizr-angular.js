/**
 * @license AngularJS v1.2.6-build.local+sha.bc1f56e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.bc1f56e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.bc1f56e',    // all of these placeholder strings will be replaced by grunt's
