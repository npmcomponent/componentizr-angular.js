/**
 * @license AngularJS v1.2.5-bde0f1e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-bde0f1e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-bde0f1e',    // all of these placeholder strings will be replaced by grunt's
