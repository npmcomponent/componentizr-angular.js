/**
 * @license AngularJS v1.2.6-build.local+sha.3d7e19a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.3d7e19a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.3d7e19a',    // all of these placeholder strings will be replaced by grunt's
