/**
 * @license AngularJS v1.2.6-build.local+sha.8f42b7a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.8f42b7a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.8f42b7a',    // all of these placeholder strings will be replaced by grunt's
