/**
 * @license AngularJS v1.2.5-cb7d7b5
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-cb7d7b5/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-cb7d7b5',    // all of these placeholder strings will be replaced by grunt's
