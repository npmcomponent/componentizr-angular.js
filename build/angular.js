/**
 * @license AngularJS v1.2.3-d137b6e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-d137b6e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-d137b6e',    // all of these placeholder strings will be replaced by grunt's
