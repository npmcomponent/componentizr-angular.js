/**
 * @license AngularJS v1.2.2-184bf18
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-184bf18/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-184bf18',    // all of these placeholder strings will be replaced by grunt's
