/**
 * @license AngularJS v1.2.5-abdd8ac
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-abdd8ac/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-abdd8ac',    // all of these placeholder strings will be replaced by grunt's
