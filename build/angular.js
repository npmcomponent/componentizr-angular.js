/**
 * @license AngularJS v1.2.2-a8ef38b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-a8ef38b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-a8ef38b',    // all of these placeholder strings will be replaced by grunt's
