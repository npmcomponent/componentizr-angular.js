/**
 * @license AngularJS v1.2.3-10f91eb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-10f91eb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-10f91eb',    // all of these placeholder strings will be replaced by grunt's
