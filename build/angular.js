/**
 * @license AngularJS v1.2.2-2952baf
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-2952baf/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-2952baf',    // all of these placeholder strings will be replaced by grunt's
