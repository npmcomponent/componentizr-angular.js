/**
 * @license AngularJS v1.2.7-build.local+sha.b2499ce
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.b2499ce/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.b2499ce',    // all of these placeholder strings will be replaced by grunt's
