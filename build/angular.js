/**
 * @license AngularJS v1.2.7-build.local+sha.0f0d39e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.0f0d39e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.0f0d39e',    // all of these placeholder strings will be replaced by grunt's
