/**
 * @license AngularJS v1.2.4-19f8e53
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-19f8e53/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-19f8e53',    // all of these placeholder strings will be replaced by grunt's
