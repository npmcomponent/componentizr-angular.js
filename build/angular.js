/**
 * @license AngularJS v1.2.4-8dadbfd
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-8dadbfd/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-8dadbfd',    // all of these placeholder strings will be replaced by grunt's
