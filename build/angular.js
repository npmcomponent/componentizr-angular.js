/**
 * @license AngularJS v1.2.7-build.local+sha.c2b43ea
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.c2b43ea/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.c2b43ea',    // all of these placeholder strings will be replaced by grunt's
