/**
 * @license AngularJS v1.2.6-build.local+sha.79b125b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.79b125b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.79b125b',    // all of these placeholder strings will be replaced by grunt's
