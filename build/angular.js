/**
 * @license AngularJS v1.2.2-1fd09be
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-1fd09be/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-1fd09be',    // all of these placeholder strings will be replaced by grunt's
