/**
 * @license AngularJS v1.2.2-b22bdda
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-b22bdda/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-b22bdda',    // all of these placeholder strings will be replaced by grunt's
