/**
 * @license AngularJS v1.2.6-build.local+sha.19c141d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.19c141d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.19c141d',    // all of these placeholder strings will be replaced by grunt's
