/**
 * @license AngularJS v1.2.5-146a8de
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-146a8de/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-146a8de',    // all of these placeholder strings will be replaced by grunt's
