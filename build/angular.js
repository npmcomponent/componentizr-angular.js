/**
 * @license AngularJS v1.2.3-52362bc
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-52362bc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-52362bc',    // all of these placeholder strings will be replaced by grunt's
