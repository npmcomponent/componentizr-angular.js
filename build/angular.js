/**
 * @license AngularJS v1.2.4-48960df
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-48960df/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-48960df',    // all of these placeholder strings will be replaced by grunt's
