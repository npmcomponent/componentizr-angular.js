/**
 * @license AngularJS v1.2.3-1585f1a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-1585f1a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-1585f1a',    // all of these placeholder strings will be replaced by grunt's
