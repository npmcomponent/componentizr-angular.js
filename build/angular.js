/**
 * @license AngularJS v1.2.4-d74f98d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-d74f98d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-d74f98d',    // all of these placeholder strings will be replaced by grunt's
