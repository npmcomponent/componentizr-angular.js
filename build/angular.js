/**
 * @license AngularJS v1.2.3-2021a5e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-2021a5e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-2021a5e',    // all of these placeholder strings will be replaced by grunt's
