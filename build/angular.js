/**
 * @license AngularJS v1.2.2-4e3e3ea
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-4e3e3ea/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-4e3e3ea',    // all of these placeholder strings will be replaced by grunt's
