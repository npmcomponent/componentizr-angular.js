/**
 * @license AngularJS v1.3.0-local+sha.fbd4b69
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.fbd4b69/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.fbd4b69',    // all of these placeholder strings will be replaced by grunt's
