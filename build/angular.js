/**
 * @license AngularJS v1.2.6-build.local+sha.07b0a2c
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.07b0a2c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.07b0a2c',    // all of these placeholder strings will be replaced by grunt's
