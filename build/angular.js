/**
 * @license AngularJS v1.2.1-cfe00fb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.1-cfe00fb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.1-cfe00fb',    // all of these placeholder strings will be replaced by grunt's
