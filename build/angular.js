/**
 * @license AngularJS v1.2.8-build.local+sha.7fa9d80
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.8-build.local+sha.7fa9d80/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.8-build.local+sha.7fa9d80',    // all of these placeholder strings will be replaced by grunt's
