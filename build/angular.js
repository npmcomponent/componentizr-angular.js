/**
 * @license AngularJS v1.2.4-3c3e6a5
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-3c3e6a5/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-3c3e6a5',    // all of these placeholder strings will be replaced by grunt's
