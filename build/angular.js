/**
 * @license AngularJS v1.2.7-build.local+sha.8b24a2e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.8b24a2e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.8b24a2e',    // all of these placeholder strings will be replaced by grunt's
