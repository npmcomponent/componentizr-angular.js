/**
 * @license AngularJS v1.3.0-local+sha.8891622
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.8891622/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.8891622',    // all of these placeholder strings will be replaced by grunt's
