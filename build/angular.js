/**
 * @license AngularJS v1.2.3-db5beca
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-db5beca/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-db5beca',    // all of these placeholder strings will be replaced by grunt's
