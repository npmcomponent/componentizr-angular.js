/**
 * @license AngularJS v1.2.8-build.local+sha.a221c7c
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.8-build.local+sha.a221c7c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.8-build.local+sha.a221c7c',    // all of these placeholder strings will be replaced by grunt's
