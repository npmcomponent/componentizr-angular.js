/**
 * @license AngularJS v1.2.7-build.local+sha.ff62b9e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.ff62b9e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.ff62b9e',    // all of these placeholder strings will be replaced by grunt's
