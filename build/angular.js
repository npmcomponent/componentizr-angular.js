/**
 * @license AngularJS v1.2.6-build.local+sha.ea54d45
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.ea54d45/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.ea54d45',    // all of these placeholder strings will be replaced by grunt's
