/**
 * @license AngularJS v1.2.7-build.local+sha.b8b2b7d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.b8b2b7d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.b8b2b7d',    // all of these placeholder strings will be replaced by grunt's
