/**
 * @license AngularJS v1.2.2-307cd9b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-307cd9b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-307cd9b',    // all of these placeholder strings will be replaced by grunt's
