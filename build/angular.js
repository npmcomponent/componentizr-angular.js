/**
 * @license AngularJS v1.2.7-build.local+sha.27e789b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.27e789b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.27e789b',    // all of these placeholder strings will be replaced by grunt's
