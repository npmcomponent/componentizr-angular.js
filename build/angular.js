/**
 * @license AngularJS v1.2.7-build.local+sha.2ace11c
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.2ace11c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.2ace11c',    // all of these placeholder strings will be replaced by grunt's
