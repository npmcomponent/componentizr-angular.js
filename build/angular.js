/**
 * @license AngularJS v1.2.4-79f69ff
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-79f69ff/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-79f69ff',    // all of these placeholder strings will be replaced by grunt's
