/**
 * @license AngularJS v1.2.6-build.local+sha.31d058d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.31d058d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.31d058d',    // all of these placeholder strings will be replaced by grunt's
