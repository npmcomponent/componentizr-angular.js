/**
 * @license AngularJS v1.2.6-build.local+sha.38cfa6a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.38cfa6a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.38cfa6a',    // all of these placeholder strings will be replaced by grunt's
