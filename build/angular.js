/**
 * @license AngularJS v1.2.4-6b7eaef
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-6b7eaef/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-6b7eaef',    // all of these placeholder strings will be replaced by grunt's
