/**
 * @license AngularJS v1.2.1-b85438d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.1-b85438d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.1-b85438d',    // all of these placeholder strings will be replaced by grunt's
