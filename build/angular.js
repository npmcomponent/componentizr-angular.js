/**
 * @license AngularJS v1.2.7-build.local+sha.72d600d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.72d600d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.72d600d',    // all of these placeholder strings will be replaced by grunt's
