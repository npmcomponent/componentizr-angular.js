/**
 * @license AngularJS v1.2.5-ca59f55
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-ca59f55/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-ca59f55',    // all of these placeholder strings will be replaced by grunt's
