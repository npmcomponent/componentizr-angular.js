/**
 * @license AngularJS v1.2.3-ee1f81f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-ee1f81f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-ee1f81f',    // all of these placeholder strings will be replaced by grunt's
