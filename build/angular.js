/**
 * @license AngularJS v1.2.5-aa658cd
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-aa658cd/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-aa658cd',    // all of these placeholder strings will be replaced by grunt's
