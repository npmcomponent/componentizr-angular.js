/**
 * @license AngularJS v1.2.7-build.local+sha.fc1f2cc
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.fc1f2cc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.fc1f2cc',    // all of these placeholder strings will be replaced by grunt's
