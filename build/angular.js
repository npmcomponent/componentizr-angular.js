/**
 * @license AngularJS v1.2.7-build.local+sha.e4a9148
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.e4a9148/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.e4a9148',    // all of these placeholder strings will be replaced by grunt's
