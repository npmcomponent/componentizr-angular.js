/**
 * @license AngularJS v1.2.6-build.local+sha.56bd19b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.56bd19b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.56bd19b',    // all of these placeholder strings will be replaced by grunt's
