/**
 * @license AngularJS v1.2.7-build.local+sha.0322f4e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.0322f4e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.0322f4e',    // all of these placeholder strings will be replaced by grunt's
