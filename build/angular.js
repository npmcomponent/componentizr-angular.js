/**
 * @license AngularJS v1.2.4-9dcbcbe
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-9dcbcbe/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-9dcbcbe',    // all of these placeholder strings will be replaced by grunt's
