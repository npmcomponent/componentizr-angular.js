/**
 * @license AngularJS v1.2.4-711bd9f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-711bd9f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-711bd9f',    // all of these placeholder strings will be replaced by grunt's
