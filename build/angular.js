/**
 * @license AngularJS v1.2.5-f796ccc
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-f796ccc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-f796ccc',    // all of these placeholder strings will be replaced by grunt's
