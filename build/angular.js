/**
 * @license AngularJS v1.2.3-d30d3cb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-d30d3cb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-d30d3cb',    // all of these placeholder strings will be replaced by grunt's
