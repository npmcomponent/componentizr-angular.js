/**
 * @license AngularJS v1.2.5-381a9bf
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-381a9bf/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-381a9bf',    // all of these placeholder strings will be replaced by grunt's
