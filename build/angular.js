/**
 * @license AngularJS v1.2.4-011b4fc
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-011b4fc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-011b4fc',    // all of these placeholder strings will be replaced by grunt's
