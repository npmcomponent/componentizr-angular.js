/**
 * @license AngularJS v1.2.5-164935a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-164935a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-164935a',    // all of these placeholder strings will be replaced by grunt's
