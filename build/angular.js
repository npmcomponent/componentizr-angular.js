/**
 * @license AngularJS v1.2.3-dfc5d8e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-dfc5d8e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-dfc5d8e',    // all of these placeholder strings will be replaced by grunt's
