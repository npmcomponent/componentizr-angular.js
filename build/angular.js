/**
 * @license AngularJS v1.2.4-cba9e7d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-cba9e7d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-cba9e7d',    // all of these placeholder strings will be replaced by grunt's
