/**
 * @license AngularJS v1.2.6-build.local+sha.1b549ac
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.1b549ac/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.1b549ac',    // all of these placeholder strings will be replaced by grunt's
