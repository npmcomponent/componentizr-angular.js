/**
 * @license AngularJS v1.2.7-build.local+sha.fa5e81a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.fa5e81a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.fa5e81a',    // all of these placeholder strings will be replaced by grunt's
