/**
 * @license AngularJS v1.2.6-build.local+sha.f34a9dc
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.f34a9dc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.f34a9dc',    // all of these placeholder strings will be replaced by grunt's
