/**
 * @license AngularJS v1.2.5-0d0a5ed
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-0d0a5ed/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-0d0a5ed',    // all of these placeholder strings will be replaced by grunt's
