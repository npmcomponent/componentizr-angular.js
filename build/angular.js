/**
 * @license AngularJS v1.2.5-537ac7e
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-537ac7e/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-537ac7e',    // all of these placeholder strings will be replaced by grunt's
