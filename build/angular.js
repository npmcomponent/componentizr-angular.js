/**
 * @license AngularJS v1.2.4-9ec95be
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-9ec95be/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-9ec95be',    // all of these placeholder strings will be replaced by grunt's
