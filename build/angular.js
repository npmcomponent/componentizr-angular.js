/**
 * @license AngularJS v1.2.2-325aecc
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-325aecc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-325aecc',    // all of these placeholder strings will be replaced by grunt's
