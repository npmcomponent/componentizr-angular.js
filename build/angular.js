/**
 * @license AngularJS v1.2.4-b4d4e3f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-b4d4e3f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-b4d4e3f',    // all of these placeholder strings will be replaced by grunt's
