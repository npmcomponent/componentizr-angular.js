/**
 * @license AngularJS v1.2.3-ce75dac
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-ce75dac/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-ce75dac',    // all of these placeholder strings will be replaced by grunt's
