/**
 * @license AngularJS v1.2.4-0b53f3a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-0b53f3a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-0b53f3a',    // all of these placeholder strings will be replaced by grunt's
