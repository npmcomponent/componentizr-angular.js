/**
 * @license AngularJS v1.2.7-build.local+sha.2a8d8ff
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.2a8d8ff/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.2a8d8ff',    // all of these placeholder strings will be replaced by grunt's
