/**
 * @license AngularJS v1.2.2-7711bab
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-7711bab/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-7711bab',    // all of these placeholder strings will be replaced by grunt's
