/**
 * @license AngularJS v1.2.2-b511adb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-b511adb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-b511adb',    // all of these placeholder strings will be replaced by grunt's
