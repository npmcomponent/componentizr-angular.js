/**
 * @license AngularJS v1.2.5-4818abe
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.5-4818abe/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.5-4818abe',    // all of these placeholder strings will be replaced by grunt's
