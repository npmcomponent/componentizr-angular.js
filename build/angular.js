/**
 * @license AngularJS v1.2.6-build.local+sha.5fabe3f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.5fabe3f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.5fabe3f',    // all of these placeholder strings will be replaced by grunt's
