/**
 * @license AngularJS v1.2.7-build.local+sha.ae7d6cb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.ae7d6cb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.ae7d6cb',    // all of these placeholder strings will be replaced by grunt's
