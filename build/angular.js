/**
 * @license AngularJS v1.2.3-a9689fe
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-a9689fe/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-a9689fe',    // all of these placeholder strings will be replaced by grunt's
