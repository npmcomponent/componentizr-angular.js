/**
 * @license AngularJS v1.2.6-build.local+sha.7b3d9ee
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.7b3d9ee/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.7b3d9ee',    // all of these placeholder strings will be replaced by grunt's
