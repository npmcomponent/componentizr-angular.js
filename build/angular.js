/**
 * @license AngularJS v1.2.6-build.local+sha.03ad77c
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.03ad77c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.03ad77c',    // all of these placeholder strings will be replaced by grunt's
