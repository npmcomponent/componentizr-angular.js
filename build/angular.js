/**
 * @license AngularJS v1.2.3-5b3a69a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-5b3a69a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-5b3a69a',    // all of these placeholder strings will be replaced by grunt's
