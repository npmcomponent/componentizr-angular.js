/**
 * @license AngularJS v1.2.4-0745b0d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-0745b0d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-0745b0d',    // all of these placeholder strings will be replaced by grunt's
