/**
 * @license AngularJS v1.2.4-5046e4d
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-5046e4d/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-5046e4d',    // all of these placeholder strings will be replaced by grunt's
