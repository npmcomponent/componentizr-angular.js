/**
 * @license AngularJS v1.2.3-53556df
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-53556df/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-53556df',    // all of these placeholder strings will be replaced by grunt's
