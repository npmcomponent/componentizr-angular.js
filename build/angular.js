/**
 * @license AngularJS v1.2.2-7d9cd7b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-7d9cd7b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-7d9cd7b',    // all of these placeholder strings will be replaced by grunt's
