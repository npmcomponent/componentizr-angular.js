/**
 * @license AngularJS v1.2.3-854d4bf
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-854d4bf/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-854d4bf',    // all of these placeholder strings will be replaced by grunt's
