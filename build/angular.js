/**
 * @license AngularJS v1.2.2-d80b79f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-d80b79f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-d80b79f',    // all of these placeholder strings will be replaced by grunt's
