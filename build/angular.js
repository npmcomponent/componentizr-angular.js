/**
 * @license AngularJS v1.2.2-52febf2
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-52febf2/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-52febf2',    // all of these placeholder strings will be replaced by grunt's
