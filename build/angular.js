/**
 * @license AngularJS v1.2.2-91057bc
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-91057bc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-91057bc',    // all of these placeholder strings will be replaced by grunt's
