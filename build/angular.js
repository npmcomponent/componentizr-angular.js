/**
 * @license AngularJS v1.2.7-build.local+sha.1e788ae
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.1e788ae/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.1e788ae',    // all of these placeholder strings will be replaced by grunt's
