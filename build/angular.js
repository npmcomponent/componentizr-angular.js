/**
 * @license AngularJS v1.2.7-build.local+sha.ee7e9eb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.ee7e9eb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.ee7e9eb',    // all of these placeholder strings will be replaced by grunt's
