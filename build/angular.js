/**
 * @license AngularJS v1.2.7-build.local+sha.9ca3a1c
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.7-build.local+sha.9ca3a1c/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.7-build.local+sha.9ca3a1c',    // all of these placeholder strings will be replaced by grunt's
