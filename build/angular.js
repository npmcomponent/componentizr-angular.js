/**
 * @license AngularJS v1.2.6-build.local+sha.c650a2a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.c650a2a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.c650a2a',    // all of these placeholder strings will be replaced by grunt's
