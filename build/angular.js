/**
 * @license AngularJS v1.2.6-build.local+sha.d778dbb
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.d778dbb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.d778dbb',    // all of these placeholder strings will be replaced by grunt's
