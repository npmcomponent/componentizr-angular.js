/**
 * @license AngularJS v1.2.2-3e7a3ec
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-3e7a3ec/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-3e7a3ec',    // all of these placeholder strings will be replaced by grunt's
