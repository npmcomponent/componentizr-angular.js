/**
 * @license AngularJS v1.2.3-8e78f43
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.3-8e78f43/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.3-8e78f43',    // all of these placeholder strings will be replaced by grunt's
