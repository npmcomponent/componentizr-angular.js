/**
 * @license AngularJS v1.2.2-d09b5aa
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.2-d09b5aa/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.2-d09b5aa',    // all of these placeholder strings will be replaced by grunt's
