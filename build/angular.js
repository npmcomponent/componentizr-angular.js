/**
 * @license AngularJS v1.2.8-build.local+sha.41faf2f
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.8-build.local+sha.41faf2f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.8-build.local+sha.41faf2f',    // all of these placeholder strings will be replaced by grunt's
