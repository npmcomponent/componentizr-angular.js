/**
 * @license AngularJS v1.2.6-build.local+sha.7d63d9b
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.7d63d9b/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.7d63d9b',    // all of these placeholder strings will be replaced by grunt's
