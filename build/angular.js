/**
 * @license AngularJS v1.2.4-4957bd4
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-4957bd4/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-4957bd4',    // all of these placeholder strings will be replaced by grunt's
