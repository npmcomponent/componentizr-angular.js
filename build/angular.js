/**
 * @license AngularJS v1.2.4-1d0bca1
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.4-1d0bca1/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.4-1d0bca1',    // all of these placeholder strings will be replaced by grunt's
