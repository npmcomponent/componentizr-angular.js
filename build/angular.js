/**
 * @license AngularJS v1.2.6-build.local+sha.f7f1bed
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.f7f1bed/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.f7f1bed',    // all of these placeholder strings will be replaced by grunt's
