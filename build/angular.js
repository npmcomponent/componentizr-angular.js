/**
 * @license AngularJS v1.2.6-build.local+sha.baa72cc
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.6-build.local+sha.baa72cc/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.6-build.local+sha.baa72cc',    // all of these placeholder strings will be replaced by grunt's
